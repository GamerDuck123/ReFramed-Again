...
public interface ICTMQuadTransform extends RenderContext.QuadTransform {
    ...
    void invokePrepare(BlockRenderView view, BlockState appearance, BlockState state, BlockPos pos, Supplier<Random> random, RenderContext ctx, boolean manual_culling, Function<Sprite, QuadProcessors.Slice> slice);
